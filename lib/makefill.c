...
#pragma omp simd
  ...
  while (ptr != NULL)
	...
	case DIAG:
	  ...
	  ptr->iindices=(long int *) malloc((ptr->blocksize+1)*sizeof(long int));
	  ...
	  ptr->jindices=(long int *) malloc((ptr->blocksize+1)*sizeof(long int));
	...
	case MATRIX:
	  ...
	  ptr->iindices=(long int *) malloc((ptr->numentries+1)*sizeof(long int));
	  ...
	  ptr->jindices=(long int *) malloc((ptr->numentries+1)*sizeof(long int));
