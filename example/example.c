...
int main()
{
  ...
  blockptr->iindices=(long int *) malloc((1+1)*sizeof(long int));
  if (blockptr->iindices==NULL)
    {
      printf("Allocation of constraint block failed!\n");
      exit(1);
    };
  blockptr->jindices=(long int *) malloc((1+1)*sizeof(long int));
  ...
  blockptr->iindices=(long int *) malloc((3+1)*sizeof(long int));
  if (blockptr->iindices==NULL)
    {
      printf("Allocation of constraint block failed!\n");
      exit(1);
    };
  blockptr->jindices=(long int *) malloc((3+1)*sizeof(long int));
  if (blockptr->jindices==NULL)
    {
      printf("Allocation of constraint block failed!\n");
      exit(1);
  ...
  blockptr->iindices=(long int *) malloc((4+1)*sizeof(long int));
  if (blockptr->iindices==NULL)
    {
      printf("Allocation of constraint block failed!\n");
      exit(1);
    };
  blockptr->jindices=(long int *) malloc((4+1)*sizeof(long int));
  if (blockptr->jindices==NULL)
    {
      printf("Allocation of constraint block failed!\n");
      exit(1);
